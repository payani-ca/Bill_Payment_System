...
export default function DTHDialog({ open, onClose }) {
      ...
      <DialogContent sx={{ pt: 3, pb: 3, px: 4 }}>
        <Stack spacing={3}>
          ...
          <FormControl fullWidth>
            <InputLabel id="provider-label">DTH Provider</InputLabel>
            <Select
            ...
            {billAmount !== null && (
              ...
              >
                ...
                >
                  ...
                  <Typography variant="h2" fontWeight={700} color="primary.main" sx={{ my: 2 }}>
                    ₹ {billAmount}
                  </Typography>
